...
exports.ProductDataServices = void 0;
const product_model_1 = require("./product.model");
const createProductIntoDB = (productData) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield product_model_1.Product.create(productData);
    return result;
});
const getAllProductsFromDB = (...args_1) => __awaiter(void 0, [...args_1], void 0, function* (searchTerm = "") {
...
const updateProductInDB = (productId, data) => __awaiter(void 0, void 0, void 0, function* () {
